...
static constexpr auto s_tag = "[rawDataBufferProducer]";

TEST_CASE("Standard checks of rawDataBufferProducer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("rawDataBufferProducer"
